...
class Moon
{
	...
	public static function fixangle($x)
	{
	...
	public static function todeg($x)
	{
		return ($x * (180.0 / M_PI));
	}               # rad->deg

	public static function jtime($t)
	{
...
echo "Луна освещена в " . number_format($MoonPhase * 100, 2, ',', '') . "%" . "<br>";
echo "Его возраст " . number_format($MoonAge, 0, ',', '') . " дней" . "<br>";
echo "И находится на расстоянии " . number_format($MoonDist, 0, ',', '') . " km относительно Земли." . "<br>";
